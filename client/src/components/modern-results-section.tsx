        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-4 border border-slate-200/50">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div>
                <p className="text-sm font-medium text-slate-600">50% Confident</p>
                <p className="text-lg font-bold text-slate-900">{results.p50Date}</p>
              </div>
            </div>
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-4 border border-slate-200/50">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div>
                <p className="text-sm font-medium text-slate-600">80% Confident</p>
                <p className="text-lg font-bold text-slate-900">{results.p80Date}</p>
              </div>
            </div>
            <p className="text-xs text-slate-500">
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-4 border border-slate-200/50">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div>
                <p className="text-sm font-medium text-slate-600">95% Confident</p>
                <p className="text-lg font-bold text-slate-900">{results.p95Date}</p>
              </div>
            </div>
            <p className="text-xs text-slate-500">
              Worst-case scenario
